...
//     items = searchList.getElementsByTagName('li');
//   }
// }
...
// function arrowsKeyHandler(event, items) {
...
// // items.addEventListener("focusin", (index) => {
// //   currentFocus = index;
// //   if (currentFocus > -1) {
// //     items[currentFocus].classList.remove("active");
// //   }
...
// // items.addEventListener("focusout", (index) => {
// //   currentFocus = index;
// //   if (currentFocus < -1) {
